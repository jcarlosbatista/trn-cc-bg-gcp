...
if __name__ == '__main__':
    ...
    get_users_file = "gs://owshq-landing-zone/files/users/*.json"
    get_business_file = "gs://owshq-landing-zone/files/business/*.json"
    get_reviews_file = "gs://owshq-landing-zone/files/reviews/*.json"
